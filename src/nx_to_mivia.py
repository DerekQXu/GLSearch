...
def get_current_label(attr, label_key):
    current_label_list = []
    for label_key_elt in label_key.split('|'):
        current_label_list.append(str(attr[label_key_elt]))
    current_label = '|'.join(current_label_list)
